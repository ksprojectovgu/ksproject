...
#set load directory
parser.add_argument('--dcm_path', dest='dcm_path', default= '/project/mpattadk/data', help='dicom file directory')
parser.add_argument('--LDCT_path', dest='LDCT_path', default= "/project/mpattadk/data/N090c.nrrd", help='LDCT image folder name')
parser.add_argument('--NDCT_path', dest='NDCT_path', default= "/project/mpattadk/data/N090c.nrrd", help='NDCT image folder name')
parser.add_argument('--test_patient_no', dest='test_patient_no',type=ut.ParseList, default= 'N006')
parser.add_argument('--pretrained_vgg', dest='pretrained_vgg', default='/project/mpattadk/data-GAN', help='pretrained vggnet directory(only wgan_vgg)')

#set save directory
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir',  default='/project/mpattadk/data-GAN/checkpoint', help='check point dir')
parser.add_argument('--test_npy_save_dir', dest='test_npy_save_dir',  default='/project/mpattadk/data-GAN', help='test numpy file save dir')
